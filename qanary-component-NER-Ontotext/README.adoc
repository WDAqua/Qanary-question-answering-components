...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/ontotext/ner/OntoTextNER.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ner-ontotext.jar -t qanary/qanary-component-ner-ontotext .
----
