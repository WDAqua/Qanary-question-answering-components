 ...
 * <p>
 * {@link OntoTextNER} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        OntoTextNER component = applicationContext.getBean(OntoTextNER.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the OntoTextNER must be the very same instance");
    }
}
