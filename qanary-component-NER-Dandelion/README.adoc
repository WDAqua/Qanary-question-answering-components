...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/dandelion/ner/Dandelion.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ner-dandelion.jar -t qanary/qanary-component-ner-dandelion .
----
