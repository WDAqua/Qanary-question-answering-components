 ...
 * <p>
 * {@link Dandelion} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        Dandelion component = applicationContext.getBean(Dandelion.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the Dandelion must be the very same instance");
    }
}
