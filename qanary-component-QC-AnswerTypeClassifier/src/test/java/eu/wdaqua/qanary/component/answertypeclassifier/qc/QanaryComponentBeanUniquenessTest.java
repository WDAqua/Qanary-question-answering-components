 ...
 * <p>
 * {@link AnswerTypeClassifier} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        AnswerTypeClassifier component = applicationContext.getBean(AnswerTypeClassifier.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the AnswerTypeClassifier must be the very same instance");
    }
}
