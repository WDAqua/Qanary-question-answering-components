...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/aylien/ned/AylienNED.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ned-aylien.jar -t qanary/qanary-component-ned-aylien .
----
