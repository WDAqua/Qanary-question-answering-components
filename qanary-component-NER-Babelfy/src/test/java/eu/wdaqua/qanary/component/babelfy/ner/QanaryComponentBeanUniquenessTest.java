 ...
 * <p>
 * {@link Babelfy} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        Babelfy component = applicationContext.getBean(Babelfy.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the Babelfy must be the very same instance");
    }
}
