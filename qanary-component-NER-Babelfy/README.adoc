...
* *External service:* https://babelfy.io/v1/disambiguate?text=
...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/babelfy/ner/Babelfy.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ner-babelfy.jar -t qanary/qanary-component-ner-babelfy .
----
