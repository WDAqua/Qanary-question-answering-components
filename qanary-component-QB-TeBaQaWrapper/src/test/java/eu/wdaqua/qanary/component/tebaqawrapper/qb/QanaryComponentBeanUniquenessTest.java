 ...
 * <p>
 * {@link TeBaQAQueryBuilder} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        TeBaQAQueryBuilder component = applicationContext.getBean(TeBaQAQueryBuilder.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the TeBaQAQueryBuilder must be the very same instance");
    }
}
