 ...
 * <p>
 * {@link OpenTapiocaNED} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        OpenTapiocaNED component = applicationContext.getBean(OpenTapiocaNED.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the OpenTapiocaNED must be the very same instance");
    }
}
