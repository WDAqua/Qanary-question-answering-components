...
@TestConfiguration
public class BabelfyTestConfiguration {
    ...
    static {
        ...
        System.setProperty("qanary.webservicecalls.cache.specs", "maximumSize=1000,expireAfterAccess=" + BabelfyCacheTests.MAX_TIME_SPAN_SECONDS + "s");
    }
    ...
    protected static String getStringFromFile(String filename) throws IOException {
        String path = BabelfyTestConfiguration.class.getClassLoader().getResource(filename).getPath();
