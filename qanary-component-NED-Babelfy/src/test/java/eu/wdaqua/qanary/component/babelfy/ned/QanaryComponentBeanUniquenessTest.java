 ...
 * <p>
 * {@link BabelfyNED} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        BabelfyNED component = applicationContext.getBean(BabelfyNED.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the BabelfyNED must be the very same instance");
    }
}
