...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/babelfy/ned/BabelfyNED.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
* *Tests:* 6 test class(es) under `src/test/java/` (`BabelfyLiveTests.java`, `BabelfyMockedTests.java`, `BabelfyTestConfiguration.java`, `CacheTests.java`, `QanaryServiceControllerTests.java`, `SwaggerUiAvailabilityTest.java`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ned-babelfy.jar -t qanary/qanary-component-ned-babelfy .
----
