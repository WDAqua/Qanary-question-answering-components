 ...
 * <p>
 * {@link TagmeNED} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        TagmeNED component = applicationContext.getBean(TagmeNED.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the TagmeNED must be the very same instance");
    }
}
