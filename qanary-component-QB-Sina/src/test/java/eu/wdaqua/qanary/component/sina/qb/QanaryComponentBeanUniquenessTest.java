 ...
 * <p>
 * {@link SINA} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        SINA component = applicationContext.getBean(SINA.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the SINA must be the very same instance");
    }
}
