...
public class LanguageDetectionTest {
    ...
    @Test
    void testUncommonInput() throws LangDetectException, IOException {
     ...
     */
    @Test
    void testEnglishLanguages() throws LangDetectException, IOException {
        String[] englishQuestions = { //
     ...
     */
    @Test
    void testGermanLanguages() throws LangDetectException, IOException {
    ...
    private void checkDetectedLanguageForQuestion(String[] questions, String expectedLanguage)
        ...
        assertTrue(ratio >= expectedQualityAsPercent, //
                "Language detection quality not sufficient (" + ratio + "%). " //
