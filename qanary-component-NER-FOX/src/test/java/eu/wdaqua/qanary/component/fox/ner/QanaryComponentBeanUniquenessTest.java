 ...
 * <p>
 * {@link FOXComponent} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        FOXComponent component = applicationContext.getBean(FOXComponent.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the FOXComponent must be the very same instance");
    }
}
