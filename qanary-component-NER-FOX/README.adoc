...
* *External service:* http://fox-demo.aksw.org/api
...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/fox/ner/FOXComponent.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ner-fox.jar -t qanary/qanary-component-ner-fox .
----
