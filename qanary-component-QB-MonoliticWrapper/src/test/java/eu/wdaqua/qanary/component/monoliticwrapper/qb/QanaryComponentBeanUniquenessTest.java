 ...
 * <p>
 * {@link Monolitic} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        Monolitic component = applicationContext.getBean(Monolitic.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the Monolitic must be the very same instance");
    }
}
