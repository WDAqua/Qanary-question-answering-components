...
public class DBpediaSpotlightNER extends QanaryComponent {
    ...
    @Inject
	private DBpediaSpotlightConfiguration dBpediaSpotlightConfiguration;

	@Inject
	private DBpediaSpotlightServiceFetcher dBpediaSpotlightServiceFetcher;
    ...
    public QanaryMessage process(QanaryMessage myQanaryMessage) {
        ...
        try {
            ...
            logger.info("process question \"{}\" with DBpedia Spotlight at {} and minimum confidence: {}", 
                    myQuestion, dBpediaSpotlightConfiguration.getEndpoint(),
				    dBpediaSpotlightConfiguration.getConfidenceMinimum());
            	
            // STEP2: Call the DBpedia service
            JsonArray resources;
            resources = dBpediaSpotlightServiceFetcher.getJsonFromService(
                    myQuestion, //
