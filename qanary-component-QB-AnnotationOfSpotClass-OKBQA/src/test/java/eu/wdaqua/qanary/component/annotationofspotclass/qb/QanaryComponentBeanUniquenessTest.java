 ...
 * <p>
 * {@link AnnotationofSpotClass} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        AnnotationofSpotClass component = applicationContext.getBean(AnnotationofSpotClass.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the AnnotationofSpotClass must be the very same instance");
    }
}
