 ...
 * <p>
 * {@link SpeechRecognitionKaldi} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        SpeechRecognitionKaldi component = applicationContext.getBean(SpeechRecognitionKaldi.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the SpeechRecognitionKaldi must be the very same instance");
    }
}
