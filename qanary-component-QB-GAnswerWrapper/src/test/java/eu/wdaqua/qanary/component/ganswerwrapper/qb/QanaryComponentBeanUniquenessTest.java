 ...
 * <p>
 * {@link GAnswerQueryBuilder} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        GAnswerQueryBuilder component = applicationContext.getBean(GAnswerQueryBuilder.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the GAnswerQueryBuilder must be the very same instance");
    }
}
