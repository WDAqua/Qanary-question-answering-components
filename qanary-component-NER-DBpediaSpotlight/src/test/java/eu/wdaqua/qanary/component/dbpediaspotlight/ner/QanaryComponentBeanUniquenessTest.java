 ...
 * <p>
 * {@link DBpediaSpotlightNER} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        DBpediaSpotlightNER component = applicationContext.getBean(DBpediaSpotlightNER.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the DBpediaSpotlightNER must be the very same instance");
    }
}
