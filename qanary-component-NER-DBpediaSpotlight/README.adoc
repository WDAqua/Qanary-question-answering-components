...
* *Note:* Represents a wrapper of the DBpedia Spotlight tool used here as a spotter.
...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/dbpediaspotlight/ner/DBpediaSpotlightNER.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ner-dbpediaspotlight.jar -t qanary/qanary-component-ner-dbpediaspotlight .
----
