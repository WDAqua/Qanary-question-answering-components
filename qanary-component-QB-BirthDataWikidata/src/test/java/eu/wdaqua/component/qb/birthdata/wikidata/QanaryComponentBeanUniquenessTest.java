 ...
 * <p>
 * {@link BirthDataQueryBuilder} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        BirthDataQueryBuilder component = applicationContext.getBean(BirthDataQueryBuilder.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the BirthDataQueryBuilder must be the very same instance");
    }
}
