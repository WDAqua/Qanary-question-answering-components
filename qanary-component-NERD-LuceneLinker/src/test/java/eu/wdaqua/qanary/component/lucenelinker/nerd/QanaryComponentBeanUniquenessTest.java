 ...
 * <p>
 * {@link LuceneLinker} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        LuceneLinker component = applicationContext.getBean(LuceneLinker.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the LuceneLinker must be the very same instance");
    }
}
