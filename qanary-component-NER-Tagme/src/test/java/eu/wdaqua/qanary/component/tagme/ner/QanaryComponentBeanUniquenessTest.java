 ...
 * <p>
 * {@link TagmeNER} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        TagmeNER component = applicationContext.getBean(TagmeNER.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the TagmeNER must be the very same instance");
    }
}
