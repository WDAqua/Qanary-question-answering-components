...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/tagme/ner/TagmeNER.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
* *Tests:* 6 test class(es) under `src/test/java/` (`CacheTests.java`, `QanaryServiceControllerTest.java`, `SwaggerUiAvailabilityTest.java`, `TagmeLiveTest.java`, `TagmeMockedTest.java`, `TagmeTestConfiguration.java`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ner-tagme.jar -t qanary/qanary-component-ner-tagme .
----
