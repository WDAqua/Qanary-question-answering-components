 ...
 * <p>
 * {@link ComicCharacterAlterEgoSimpleDBpediaQueryBuilder} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        ComicCharacterAlterEgoSimpleDBpediaQueryBuilder component = applicationContext.getBean(ComicCharacterAlterEgoSimpleDBpediaQueryBuilder.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the ComicCharacterAlterEgoSimpleDBpediaQueryBuilder must be the very same instance");
    }
}
