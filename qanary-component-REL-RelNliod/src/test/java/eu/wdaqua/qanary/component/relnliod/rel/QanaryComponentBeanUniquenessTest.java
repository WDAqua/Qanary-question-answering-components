 ...
 * <p>
 * {@link RelNliodRel} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        RelNliodRel component = applicationContext.getBean(RelNliodRel.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the RelNliodRel must be the very same instance");
    }
}
