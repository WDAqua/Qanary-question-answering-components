 ...
 * <p>
 * {@link KG2KGTranslateAnnotationsOfInstance} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        KG2KGTranslateAnnotationsOfInstance component = applicationContext.getBean(KG2KGTranslateAnnotationsOfInstance.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the KG2KGTranslateAnnotationsOfInstance must be the very same instance");
    }
}
