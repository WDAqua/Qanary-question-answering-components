 ...
 * <p>
 * {@link DiambiguationClass} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        DiambiguationClass component = applicationContext.getBean(DiambiguationClass.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the DiambiguationClass must be the very same instance");
    }
}
