 ...
 * <p>
 * {@link AmbiverseNed} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        AmbiverseNed component = applicationContext.getBean(AmbiverseNed.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the AmbiverseNed must be the very same instance");
    }
}
