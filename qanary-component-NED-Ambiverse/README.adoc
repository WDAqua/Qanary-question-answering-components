...
Comment: Ambiverse API is no longer maintained. A new local endpoint should be established following https://github.com/ambiverse-nlu/ambiverse-nlu
...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/ambiverse/ned/AmbiverseNed.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ned-ambiverse.jar -t qanary/qanary-component-ned-ambiverse .
----
