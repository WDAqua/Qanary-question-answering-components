 ...
 * <p>
 * {@link OntoTextNED} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        OntoTextNED component = applicationContext.getBean(OntoTextNED.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the OntoTextNED must be the very same instance");
    }
}
