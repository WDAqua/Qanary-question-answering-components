 ...
 * <p>
 * {@link WatsonNED} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        WatsonNED component = applicationContext.getBean(WatsonNED.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the WatsonNED must be the very same instance");
    }
}
