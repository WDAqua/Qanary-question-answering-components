 ...
 * <p>
 * {@link QueryExecuter} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        QueryExecuter component = applicationContext.getBean(QueryExecuter.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the QueryExecuter must be the very same instance");
    }
}
