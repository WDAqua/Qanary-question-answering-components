 ...
 * <p>
 * {@link QueryBuilderSimpleRealNameOfSuperHero} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        QueryBuilderSimpleRealNameOfSuperHero component = applicationContext.getBean(QueryBuilderSimpleRealNameOfSuperHero.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the QueryBuilderSimpleRealNameOfSuperHero must be the very same instance");
    }
}
