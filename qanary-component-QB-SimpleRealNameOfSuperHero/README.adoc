...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/simplerealnameofsuperhero/qb/QueryBuilderSimpleRealNameOfSuperHero.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
* *Tests:* 3 test class(es) under `src/test/java/` (`QanaryServiceControllerTest.java`, `QueryBuilderTest.java`, `SwaggerUiAvailabilityTest.java`).
...
docker build --build-arg JAR_FILE=target/qanary-component-qb-simplerealnameofsuperhero.jar -t qanary/qanary-component-qb-simplerealnameofsuperhero .
----
