 ...
 * <p>
 * {@link DandelionNED} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        DandelionNED component = applicationContext.getBean(DandelionNED.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the DandelionNED must be the very same instance");
    }
}
