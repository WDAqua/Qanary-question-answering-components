 ...
 * the enriched question from the TeBaQA API
 *
...
public class TeBaQAQueryBuilderAndExecutor extends QanaryComponent {
    ...
    protected TeBaQAResult requestTeBaQAWebService(URI uri, String questionString, String lang) throws URISyntaxException {
        ...
        HttpEntity<JSONObject> response = myRestTemplate.getForEntity(tebaqaRequest.getTeBaQAQuestionUrlAsString(), JSONObject.class);
     ...
     * @throws SparqlQueryFailed
     */
    private String getSparqlInsertQuery(QanaryQuestion<String> myQanaryQuestion, TeBaQAResult result)
