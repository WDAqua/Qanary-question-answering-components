 ...
 * <p>
 * {@link QueryBuilder} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        QueryBuilder component = applicationContext.getBean(QueryBuilder.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the QueryBuilder must be the very same instance");
    }
}
