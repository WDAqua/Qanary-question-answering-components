...
* *Language:* Python 3.
* *Major frameworks:* FastAPI, Uvicorn, `qanary-helpers` (with SentencePiece, SPARQLWrapper, torch, transformers).
* *Tests:* 2 `pytest` file(s) under `tests/` (`test_lang_utils.py`, `test_mt_helsinky_nlp.py`).
...
This component uses the https://docs.pytest.org/[pytest].
