...
Docker Hub image: [`qanary/qanary-component-mt-python-opusmt`](https://hub.docker.com/r/qanary/qanary-component-mt-python-helsinkinlp/tags)
...
**Step 1:** Clone the Git repository of the collected Qanary components:

```bash
git clone https://github.com/WDAqua/Qanary-question-answering-components.git
```

**Step 2:** Switch to the component's directory:

```bash
cd Qanary-question-answering-components/qanary-component-Python-MT-Helsinki-NLP
```

**Step 3:** Set the environment variables in the `.env` file
...
**Step 5:** Run the the component with docker-compose:
...
The necessary environment variables have to be configured in the file `pytest.ini`.
