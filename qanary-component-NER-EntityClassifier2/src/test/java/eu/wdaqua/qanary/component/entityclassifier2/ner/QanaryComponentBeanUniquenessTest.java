 ...
 * <p>
 * {@link EntityClassifier2} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        EntityClassifier2 component = applicationContext.getBean(EntityClassifier2.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the EntityClassifier2 must be the very same instance");
    }
}
