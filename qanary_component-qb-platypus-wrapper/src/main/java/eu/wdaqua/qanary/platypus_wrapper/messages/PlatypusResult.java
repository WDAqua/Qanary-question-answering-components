...
public class PlatypusResult {
    ...
    public PlatypusResult(JSONObject json, String question, URI endpoint, String language) throws URISyntaxException {
        ...
        JsonObject parsedJsonObject = jsonParser.parse(json.toJSONString()).getAsJsonObject().getAsJsonObject("member");//.getAsJsonArray("member").getAsJsonArray();
//        JsonArray parsedJsonArray = jsonParser.parse(json.toJSONString()).getAsJsonObject().getAsJsonArray("member").getAsJsonArray();
