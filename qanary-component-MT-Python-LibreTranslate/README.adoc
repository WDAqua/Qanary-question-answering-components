...
MT tool that uses https://libretranslate.com/[LibreTranslate] to translate questions into English.
...
* *Tests:* 2 `pytest` file(s) under `tests/` (`test_lang_utils.py`, `test_mt_libretranslate.py`).
