...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/relationlinker2/rel/RelationLinker2.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
