...
public class Application {
	...
	*/
	...
	public RelationLinkerConfiguration relationLinkerConfiguration(
			...
			@Value("${service.test-question}") final String testQuetsion) throws Exception 
	{
		// check functionality with live API
		for (int i = 0; i < 10; i++) {
			try {
				this.testFunctionality(testQuetsion, endpoint);
	...
	private void testFunctionality(String testQuetsion, String endpoint) throws Exception {
