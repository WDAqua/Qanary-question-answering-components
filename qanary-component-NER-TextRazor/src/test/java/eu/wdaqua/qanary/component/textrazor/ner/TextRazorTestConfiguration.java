...
public class TextRazorTestConfiguration {
    ...
    static {
        ...
        System.setProperty("qanary.webservicecalls.cache.specs", "maximumSize=1000,expireAfterAccess=" + TextRazorCacheTest.MAX_TIME_SPAN_SECONDS + "s");
    }
    ...
    protected static String getStringFromFile(String filename) throws IOException {
        String path = TextRazorTestConfiguration.class.getClassLoader().getResource(filename).getPath();
