 ...
 * <p>
 * {@link TextRazor} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        TextRazor component = applicationContext.getBean(TextRazor.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the TextRazor must be the very same instance");
    }
}
