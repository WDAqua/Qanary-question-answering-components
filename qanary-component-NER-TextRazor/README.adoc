...
= Qanary component: NER-TextRazor
...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/textrazor/ner/TextRazor.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
* *Tests:* 6 test class(es) under `src/test/java/` (`CacheTests.java`, `QanaryServiceControllerTest.java`, `SwaggerUiAvailabilityTest.java`, `TextRazorLiveTest.java`, `TextRazorMockedTest.java`, `TextRazorTestConfiguration.java`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ner-textrazor.jar -t qanary/qanary-component-ner-textrazor .
----
