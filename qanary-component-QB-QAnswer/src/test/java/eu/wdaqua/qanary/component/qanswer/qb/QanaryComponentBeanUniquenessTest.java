 ...
 * <p>
 * {@link QAnswerQueryBuilderAndSparqlResultFetcher} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        QAnswerQueryBuilderAndSparqlResultFetcher component = applicationContext.getBean(QAnswerQueryBuilderAndSparqlResultFetcher.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the QAnswerQueryBuilderAndSparqlResultFetcher must be the very same instance");
    }
}
