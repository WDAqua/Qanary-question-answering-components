 ...
 * <p>
 * {@link PlatypusQueryBuilder} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        PlatypusQueryBuilder component = applicationContext.getBean(PlatypusQueryBuilder.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the PlatypusQueryBuilder must be the very same instance");
    }
}
