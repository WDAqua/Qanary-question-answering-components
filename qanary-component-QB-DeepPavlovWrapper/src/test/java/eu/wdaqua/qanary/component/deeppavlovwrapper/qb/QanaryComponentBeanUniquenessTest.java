 ...
 * <p>
 * {@link DeepPavlovWrapper} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        DeepPavlovWrapper component = applicationContext.getBean(DeepPavlovWrapper.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the DeepPavlovWrapper must be the very same instance");
    }
}
