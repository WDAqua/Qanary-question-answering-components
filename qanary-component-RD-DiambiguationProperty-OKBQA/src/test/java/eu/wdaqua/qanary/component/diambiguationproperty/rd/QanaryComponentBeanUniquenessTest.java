 ...
 * <p>
 * {@link DiambiguationProperty} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        DiambiguationProperty component = applicationContext.getBean(DiambiguationProperty.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the DiambiguationProperty must be the very same instance");
    }
}
