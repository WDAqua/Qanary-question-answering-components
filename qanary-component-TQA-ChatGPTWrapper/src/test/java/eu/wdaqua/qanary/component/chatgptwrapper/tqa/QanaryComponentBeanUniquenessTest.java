 ...
 * <p>
 * {@link ChatGPTWrapper} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        ChatGPTWrapper component = applicationContext.getBean(ChatGPTWrapper.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the ChatGPTWrapper must be the very same instance");
    }
}
