 ...
 * <p>
 * {@link StanfordNERComponent} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        StanfordNERComponent component = applicationContext.getBean(StanfordNERComponent.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the StanfordNERComponent must be the very same instance");
    }
}
