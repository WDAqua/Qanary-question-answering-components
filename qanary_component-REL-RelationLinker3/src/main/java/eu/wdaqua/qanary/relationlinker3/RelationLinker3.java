 ...
 */
public class RelationLinker3 extends QanaryComponent {
	private static final Logger logger = LoggerFactory.getLogger(RelationLinker3.class);

	private final String applicationName;
	private final String falconAPI = "http://172.18.0.1:5002";

	public RelationLinker3(@Value("${spring.application.name}") final String applicationName) {
...
//				Iterator<?> keys = jsonObject.keys();
			...
			if(flag==0)
			{
				...
				try {
					...
					BufferedWriter buffWriter = new BufferedWriter(new FileWriter("qanary_component-REL-RelationLinker3/src/main/resources/questions.txt", true));
					Gson gson = new Gson();
