 ...
 */
public class GAnswerQueryBuilderAndExecutor extends QanaryComponent {
    private static final Logger logger = LoggerFactory.getLogger(GAnswerQueryBuilderAndExecutor.class);
    ...
    public GAnswerQueryBuilderAndExecutor(//
                                          float threshold, //
