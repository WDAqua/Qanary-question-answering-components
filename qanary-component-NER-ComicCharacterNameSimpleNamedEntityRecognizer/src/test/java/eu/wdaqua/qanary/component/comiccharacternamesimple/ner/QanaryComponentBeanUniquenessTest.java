 ...
 * <p>
 * {@link ComicCharacterNameSimpleNamedEntityRecognizer} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        ComicCharacterNameSimpleNamedEntityRecognizer component = applicationContext.getBean(ComicCharacterNameSimpleNamedEntityRecognizer.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the ComicCharacterNameSimpleNamedEntityRecognizer must be the very same instance");
    }
}
