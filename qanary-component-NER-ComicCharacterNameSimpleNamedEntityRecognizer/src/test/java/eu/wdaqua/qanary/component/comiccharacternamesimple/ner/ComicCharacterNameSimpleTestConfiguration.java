...
@TestConfiguration
public class ComicCharacterNameSimpleTestConfiguration {
    ...
    protected static String getStringFromFile(String filename) throws IOException {
        String path = ComicCharacterNameSimpleTestConfiguration.class.getClassLoader().getResource(filename).getPath();
