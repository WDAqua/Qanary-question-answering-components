 ...
 * <p>
 * {@link AnnotationofSpotProperty} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        AnnotationofSpotProperty component = applicationContext.getBean(AnnotationofSpotProperty.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the AnnotationofSpotProperty must be the very same instance");
    }
}
