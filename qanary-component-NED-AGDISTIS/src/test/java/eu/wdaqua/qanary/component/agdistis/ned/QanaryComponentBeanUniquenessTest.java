 ...
 * <p>
 * {@link Agdistis} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        Agdistis component = applicationContext.getBean(Agdistis.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the Agdistis must be the very same instance");
    }
}
