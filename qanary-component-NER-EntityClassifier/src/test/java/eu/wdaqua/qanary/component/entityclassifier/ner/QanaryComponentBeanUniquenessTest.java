 ...
 * <p>
 * {@link EntityClassifier} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        EntityClassifier component = applicationContext.getBean(EntityClassifier.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the EntityClassifier must be the very same instance");
    }
}
