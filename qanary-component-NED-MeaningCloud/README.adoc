...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/meaningcloud/ned/MeaningCloudNed.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ned-meaningcloud.jar -t qanary/qanary-component-ned-meaningcloud .
----
