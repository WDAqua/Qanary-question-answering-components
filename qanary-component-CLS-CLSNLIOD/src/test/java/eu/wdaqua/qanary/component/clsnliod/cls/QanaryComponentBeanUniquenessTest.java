 ...
 * <p>
 * {@link ClsNliodCls} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        ClsNliodCls component = applicationContext.getBean(ClsNliodCls.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the ClsNliodCls must be the very same instance");
    }
}
