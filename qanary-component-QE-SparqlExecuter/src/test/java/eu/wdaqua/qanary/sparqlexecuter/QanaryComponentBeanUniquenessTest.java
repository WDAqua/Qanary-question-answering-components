 ...
 * <p>
 * {@link SparqlExecuter} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        SparqlExecuter component = applicationContext.getBean(SparqlExecuter.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the SparqlExecuter must be the very same instance");
    }
}
