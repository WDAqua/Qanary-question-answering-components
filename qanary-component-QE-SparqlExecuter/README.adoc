...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/sparqlexecuter/SparqlExecuter.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
* *Tests:* 2 test class(es) under `src/test/java/` (`SparqlExecuterTest.java`, `SwaggerUiAvailabilityTest.java`).
...
docker build --build-arg JAR_FILE=target/qanary-component-qe-sparqlexecuter.jar -t qanary/qanary-component-qe-sparqlexecuter .
----
