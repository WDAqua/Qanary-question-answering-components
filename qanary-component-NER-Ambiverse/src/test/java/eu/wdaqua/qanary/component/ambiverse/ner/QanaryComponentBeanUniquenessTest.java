 ...
 * <p>
 * {@link AmbiverseNER} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        AmbiverseNER component = applicationContext.getBean(AmbiverseNER.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the AmbiverseNER must be the very same instance");
    }
}
