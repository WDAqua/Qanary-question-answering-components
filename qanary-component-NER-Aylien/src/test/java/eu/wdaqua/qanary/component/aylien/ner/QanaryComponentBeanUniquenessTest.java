 ...
 * <p>
 * {@link AylienNER} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        AylienNER component = applicationContext.getBean(AylienNER.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the AylienNER must be the very same instance");
    }
}
