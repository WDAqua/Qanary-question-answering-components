...
* *External service:* https://api.aylien.com/api/v1/concepts?text=
...
* *Main component class:* `src/main/java/eu/wdaqua/qanary/component/aylien/ner/AylienNER.java` (extends `eu.wdaqua.qanary.component.QanaryComponent`).
...
docker build --build-arg JAR_FILE=target/qanary-component-ner-aylien.jar -t qanary/qanary-component-ner-aylien .
----
