 ...
 * <p>
 * {@link QueryBuilderDateOfDeathDBpedia} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        QueryBuilderDateOfDeathDBpedia component = applicationContext.getBean(QueryBuilderDateOfDeathDBpedia.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the QueryBuilderDateOfDeathDBpedia must be the very same instance");
    }
}
