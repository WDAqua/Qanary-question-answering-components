 ...
 * <p>
 * {@link RuBQQueryBuilder} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        RuBQQueryBuilder component = applicationContext.getBean(RuBQQueryBuilder.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the RuBQQueryBuilder must be the very same instance");
    }
}
