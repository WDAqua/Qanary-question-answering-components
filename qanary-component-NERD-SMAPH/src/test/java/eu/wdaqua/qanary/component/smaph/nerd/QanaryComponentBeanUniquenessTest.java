 ...
 * <p>
 * {@link SmaphErd} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        SmaphErd component = applicationContext.getBean(SmaphErd.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the SmaphErd must be the very same instance");
    }
}
