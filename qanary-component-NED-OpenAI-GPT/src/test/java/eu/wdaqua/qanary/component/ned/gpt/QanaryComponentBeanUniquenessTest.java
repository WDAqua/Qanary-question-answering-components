 ...
 * <p>
 * {@link GptBasedNamedEntityDisambiguation} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        GptBasedNamedEntityDisambiguation component = applicationContext.getBean(GptBasedNamedEntityDisambiguation.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the GptBasedNamedEntityDisambiguation must be the very same instance");
    }
}
