...
@Component
public class FalconNEDEnriched extends QanaryComponent {
	private static final Logger logger = LoggerFactory.getLogger(FalconNEDEnriched.class);

	private final String applicationName;
	private final String falconAPI = "http://172.18.0.1:5002";

	public FalconNEDEnriched(@Value("${spring.application.name}") final String applicationName) {
