 ...
 * <p>
 * {@link CopyValuesOfPriorGraph} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        CopyValuesOfPriorGraph component = applicationContext.getBean(CopyValuesOfPriorGraph.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the CopyValuesOfPriorGraph must be the very same instance");
    }
}
