 ...
 * <p>
 * {@link MeaningCloud} must be registered exactly once - either by the {@code qanaryComponent()}
...
class QanaryComponentBeanUniquenessTest {
    ...
    void componentResolvesUnambiguouslyByItsConcreteType() {
        ...
        MeaningCloud component = applicationContext.getBean(MeaningCloud.class);

        assertSame(qanaryComponent, component,
                "the QanaryComponent and the MeaningCloud must be the very same instance");
    }
}
